...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const downloadResult = yield node_fetch_1.default(manifest);
            const downloadedManifest = yield downloadResult.json();
            ...
            yield utils_1.download(downloadUrl, tmpPath);
            // Now extract it.
            const enclaveBinaryPath = yield linux.extractPackage(tmpPath, `${process.env.HOME}`);
            const procId = yield runner_1.spawnEnclave(enclaveBinaryPath, core.getInput('enrolment-key'));
...
function spawnEnclave(enclavePath, enrolmentKey) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            try {
                var childProcess = child_process_1.spawn(enclavePath, ['run'], {
                    env: envCopy,
                    detached: true,
                    stdio: 'ignore'
                });
