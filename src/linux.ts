...
export function choosePackage(packages: IManifestPackage[]): IManifestPackage | null
{
  return packages.find(p => p.Architecture == 'X64') || null;
}

export async function extractPackage(tmpPath: string, destFolder: string): Promise<string>
{  
